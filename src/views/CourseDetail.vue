  ...
  <div class="mx-auto max-w-md bg-white h-screen">
    <div v-if="loading">
      <img
        ...
        alt=""
        class="pt-96 mx-auto my-auto w-10"
      />
    </div>
    <div v-else>
      <div
      ...
      <div class="p-4">
        ...
        <template
          v-for="(detail, i) in course_details[0].course_detail"
          :key="i"
        >
          <DetailCourseCard
      ...
      <router-link to="/takeclass">
        <button
          class="bg-blue-400 z-10 fixed-bottom p-4 rounded-md max-w-md mx-auto shadow-lg text-white font-semibold"
        >
          Ambil Kelas
        </button>
      </router-link>
